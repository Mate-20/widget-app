...
const usePosterGenerator = () => {
  ...
  const generatePrompt = async (location, description) => {
    try {
      ...
      const promptText = `Location is ${location}. Description is ${description}. Generate a detailed prompt without pointers for stable diffusion to generate a NICE ILLUSTRATION PAINTING/ART for the given location and description.`;
